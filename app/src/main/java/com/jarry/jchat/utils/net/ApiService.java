...
public interface ApiService {
     ...
     */
    @POST("/login")
    Observable<Response> login(@Query("phone") String userName, @Query("password") String password);

    @POST("/register")
    Observable<Response> register(@Query("phone") String userName, @Query("password") String password);
    /**
     * =============================================================================================
     *登录相关
     * ========================END==================================================================
